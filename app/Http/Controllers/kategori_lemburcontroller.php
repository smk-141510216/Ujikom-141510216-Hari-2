    ...
    public function store(Request $request)
    {
        //
         ...
         $rules=['kode_lembur'=>'required|unique:kategori_lemburs',
                 ...
                 'id_jabatan'=>'required|unique:kategori_lemburs'];
         $message=['kode_lembur.unique'=>'Masukan Sudah Ada','kode_lembur.required'=>'Kolom Jangan Kosong',
                   ...
                   'id_golongan.unique'=>'Masukan Sudah Ada','id_golongan.required'=>'Kolom Jangan Kosong',
                   'id_jabatan.unique'=>'Masukan Sudah Ada','id_jabatan.required'=>'Kolom Jangan Kosong'];
    ...
    public function update(Request $request, $id)
    {
        //
         ...
         $rules=['kode_lembur'=>'required:kategori_lemburs',
                 ...
                 'id_golongan'=>'required:kategori_lemburs',
        ...
        if ($validator->fails())
         {
            # code...
            return redirect('/kategori_lembur/3/edit')
            ->withErrors($validator)
            ->withInput();
        }
        else
