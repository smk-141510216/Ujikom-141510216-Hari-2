    ...
    public function store(Request $request)
    {
        //
         ...
         $rules=['kode_tunjangan'=>'required|unique:tunjangans',
                  'id_jabatan'=>'required|unique:tunjangans',
         ...
         $message=['kode_tunjangan.required'=>'Kolom Jangan Kosong','kode_tunjangan.unique'=>'Masukan Sudah Ada',
                   'id_jabatan.required'=>'Kolom Jangan Kosong','id_jabatan.unique'=>'Masukan Sudah Ada',
                   'id_golongan.required'=>'Kolom Jangan Kosong','id_golongan.unique'=>'Masukan Sudah Ada',
