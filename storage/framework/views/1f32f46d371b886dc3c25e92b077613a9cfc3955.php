        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                   <form action="<?php echo e(route('kategori_lembur.update',$kategori_lembur->id)); ?>" method="POST">
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group <?php echo e($errors->has('kode_lembur') ? 'has-errors':'message'); ?>" >
                                <input id="kode_lembur" type="text" class="form-control" name="kode_lembur" value="<?php echo e($kategori_lembur->kode_lembur); ?>"  autofocus>
                            ...
                            <div class="form-group <?php echo e($errors->has('besaran_uang') ? 'has-errors':'message'); ?>" >
                                <input id="besaran_uang" type="text" class="form-control" name="besaran_uang" value="<?php echo e($kategori_lembur->besaran_uang); ?>"  autofocus>
